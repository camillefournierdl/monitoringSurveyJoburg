...
forms <- list(
  "Intercept" = "AM_Knowlg_1 ~ 1",
  "Simple"       = "AM_Knowlg_1 ~ quota_age_ + perception_spatial",
...
forms <- list(
  "Intercept" = "AM_Perc ~ 1",
  "Simple"       = "AM_Perc ~ quota_age_ + perception_spatial",
...
forms <- list(
  "Intercept" = "AM_Freq ~ 1",
  "Simple"       = "AM_Freq ~ quota_age_ + perception_spatial",
...
flextable::save_as_docx("Table S1. Model summary" = summary_ft,
                        path = "revisions/summaryTableKFS.docx")
