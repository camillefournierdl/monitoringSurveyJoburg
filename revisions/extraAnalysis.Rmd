...
forms <- list(
  ...
  "AddEmploy" = "AM_Knowlg_1 ~ quota_age_ + quota_education + gender + employBin + perception_spatial",
  "Interact"  = "AM_Knowlg_1 ~ quota_age_ + quota_education + gender + employBin + quota_age_:quota_education + perception_spatial",
  "Interact2" = "AM_Knowlg_1 ~ quota_age_ + quota_education + gender + employBin + employBin:quota_education + perception_spatial",
  "Dist"      = "AM_Knowlg_1 ~ quota_age_ + quota_education + gender + employBin + distanceNearestM + perception_spatial"
)
...
coef_map <- c(
  ...
  "gendermale" = "Male",
  "quota_age_:quota_education" = "Age x Education", 
  "employBin2unemployed" = "Unemployment",
  "quota_education:employBin2unemployed" = "Education × Unemployment",
...
forms <- list(
  ...
  "AddEmploy" = "AM_Perc ~ quota_age_ + quota_education + gender + employBin + perception_spatial",
  "Interact"  = "AM_Perc ~ quota_age_ + quota_education + gender + employBin + quota_age_:quota_education + perception_spatial",
  "Interact2" = "AM_Perc ~ quota_age_ + quota_education + gender + employBin + employBin:quota_education + perception_spatial",
  "Dist"      = "AM_Perc ~ quota_age_ + quota_education + gender + employBin + distanceNearestM + perception_spatial"
)
...
forms <- list(
  ...
  "AddEmploy" = "AM_Freq ~ quota_age_ + quota_education + gender + employBin + perception_spatial",
  "Interact" = "AM_Freq ~ quota_age_ + quota_education + gender + employBin + perception_spatial + quota_age_:quota_education",
  "Interact2"  = "AM_Freq ~ quota_age_ + quota_education + gender + employBin + employBin:quota_education + perception_spatial",
  "Distance"  = "AM_Freq ~ quota_age_ + quota_education + gender + employBin + distanceNearestM + perception_spatial"
)
...
forms <- list(
  ...
  "K+unemploy"    = "AM_Knowlg_1 ~ quota_age_ + quota_education + gender + employBin + perception_spatial",
  "K+dist"       = "AM_Knowlg_1 ~ quota_age_ + quota_education + gender + employBin + distanceNearestM + perception_spatial",
  "Frequency"    = "AM_Freq ~ quota_age_ + quota_education + gender + perception_spatial",
  "F+unemploy"    = "AM_Freq ~ quota_age_ + quota_education + gender + employBin + perception_spatial",
  "F+dist"       = "AM_Freq ~ quota_age_ + quota_education + gender + employBin + distanceNearestM + perception_spatial",
  "Satisfaction" = "AM_Perc ~ quota_age_ + quota_education + gender + perception_spatial",
  "S+unemploy" = "AM_Perc ~ quota_age_ + quota_education + gender + employBin + perception_spatial",
  "S+dist"       = "AM_Perc ~ quota_age_ + quota_education + gender + employBin + distanceNearestM + perception_spatial"
  )
...
p1 <- dataJoburg %>%
  ...
  labs(title = "If you would want to know how much air pollution there is in Johannesburg,\nwould you know or not know where to find this information?",
       x = "Age Group",
       y = "Knowledge")+
  geom_boxplot(col = "black", fill = "white")+
  theme_minimal()

ggsave(plot = p1, filename = paste("revisions/plots/boxplotKnowledgeAge.png", sep = ""),
       dpi=600, width = 18, height = 10, units='cm')

p2 <- dataJoburg %>%
  filter(!is.na(AM_Freq)) %>%
  ggplot(aes(y = AM_Freq, x = age_group_cat))+
  labs(y = "Frequency of behavior",
       x = "Age Group",
       title = "How often or not do you look up information on air pollution in Johannesburg?")+
  geom_boxplot(col = "black", fill = "white")+
  theme_minimal()+
...
ggsave(plot = p2, filename = paste("revisions/plots/reviewerResponse_boxplotFreqAge.png", sep = ""),
       dpi=600, width = 18, height = 10, units='cm')
...
ggsave(plot = p3, filename = paste("revisions/plots/reviewerResponse_boxplotSatisfAge.png", sep = ""),
       dpi=600, width = 18, height = 10, units='cm')
